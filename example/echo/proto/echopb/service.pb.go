...
var file_echo_service_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Tag:           "varint,60001,opt,name=reply_code,enum=echo.ReplyCode",
...
var (
	// optional echo.ReplyCode reply_code = 60001;
...
var file_echo_service_proto_rawDesc = []byte{
	...
	0x6e, 0x74, 0x65, 0x6e, 0x74, 0x3a, 0x04, 0x88, 0xa6, 0x1d, 0x01, 0x2a, 0x25, 0x0a, 0x09, 0x52,
